...
import 'package:focus_app/features/authentification/screens/login/content/login_content.dart';
...
class LoginBlocBuilder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AppBlocBuilder<LoginCubit, LoginState>(
      listenWhen: (context, state) => state is LoginSuccess || state is LoginFailure,
